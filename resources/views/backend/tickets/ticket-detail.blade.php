...
@section('content')
                                        ...
                                        <div class="card-body">
                                            <div class="post">
                                                ...
                                                <div class="py-3">
                                                    ...
                                                    <button onclick="openGmail()" class="btn btn-primary float-sm-end  mt-2 mt-sm-0">Send</button>
    ...
    <script>
          function openGmail() {
            ...
            window.location.href = 'mailto:?subject=Subject&body=Body%20of%20the%20email';
        }
        </script>
    <!-- Jquery Page Js -->
