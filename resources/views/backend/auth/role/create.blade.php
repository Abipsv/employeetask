        ...
        <x-backend.card>
            ...
            <x-slot name="body">
                <div x-data="{userType : '{{ $model::TYPE_USER }}'}">
                    ...
                    <div class="form-group row mb-3">
                        <label for="name" id="01" class="col-md-2 col-form-label">@lang('Name')</label>

                        <div class="col-md-10">
                            <input type="text" id="02" name="name" class="form-control" placeholder="{{ __('Name') }}" value="{{ old('name') }}" maxlength="100" required />
                        </div>
                    </div>
